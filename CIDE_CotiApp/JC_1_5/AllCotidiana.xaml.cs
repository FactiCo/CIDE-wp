...
namespace JC_1_5
{
    public partial class AllCotidiana : PhoneApplicationPage
    {
        ...
        {
            NavigationService.Navigate(new Uri("/Pages/Testimonios.xaml", UriKind.Relative));
        }
        ...
        {
            NavigationService.Navigate(new Uri("/Pages/Propuestas.xaml?fbToken=", UriKind.Relative));
